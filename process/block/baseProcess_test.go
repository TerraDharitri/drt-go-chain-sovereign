...
func TestCheckProcessorNilParameters(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expectedErr: errorsDrt.ErrNilRunTypeComponents,
		},
		{
			args: func() blproc.ArgBaseProcessor {
				args := createArgBaseProcessor(coreComponents, dataComponents, bootstrapComponents, statusComponents)
		...
		},
		{
			...
			expectedErr: errorsDrt.ErrNilOutGoingOperationsPool,
		},
		{
			args: func() blproc.ArgBaseProcessor {
				args := createArgBaseProcessor(coreComponents, dataComponents, bootstrapComponents, statusComponents)
			...
			expectedErr: errorsDrt.ErrNilDataCodec,
		},
		{
			args: func() blproc.ArgBaseProcessor {
				args := createArgBaseProcessor(coreComponents, dataComponents, bootstrapComponents, statusComponents)
			...
			expectedErr: errorsDrt.ErrNilTopicsChecker,
		},
	}
