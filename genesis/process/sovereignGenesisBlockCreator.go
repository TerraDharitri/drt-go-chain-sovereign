...
import (
	...
	genesisCommon "github.com/TerraDharitri/drt-go-chain/genesis/process/common"
...
func NewSovereignGenesisBlockCreator(gbc *genesisBlockCreator) (*sovereignGenesisBlockCreator, error) {
	...
	log.Debug("NewSovereignGenesisBlockCreator", "native dcdt token", gbc.arg.Config.SovereignConfig.GenesisConfig.NativeDCDT)
