...
func TestInterceptedTxWithoutDataField(t *testing.T) {
	...
	testInterceptedTxFromFrontendGeneratedParams(
		...
		0,
		value,
		"drt12dnfhej64s6c56ka369gkyj3hwv5ms0y5rxgsk2k7hkd2vuk7rvqm22unr",
		"drt1l20m7kzfht5rhdnd4zvqr82egk7m4nvv3zk06yw82zqmrt9kf0zs5ewnr7",
...
func TestInterceptedTxWithDataField(t *testing.T) {
	...
	testInterceptedTxFromFrontendGeneratedParams(
		...
		value,
		"drt12dnfhej64s6c56ka369gkyj3hwv5ms0y5rxgsk2k7hkd2vuk7rvqm22unr",
		"drt1vjdll4xqtyll7nx3xx83audv27k5ktppvcc8kddn2yhxhwrjadgqzsupys",
...
func TestInterceptedTxWithSigningOverTxHash(t *testing.T) {
	...
	testInterceptedTxFromFrontendGeneratedParams(
		...
		1,
		value,
		"drt1ez0puv8mqsulwllnavfygfzqe5zveeqjwpr6dsm8egchkf449kjq5mtwly",
		"drt1ez0puv8mqsulwllnavfygfzqe5zveeqjwpr6dsm8egchkf449kjq5mtwly",
