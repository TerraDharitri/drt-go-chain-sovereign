...
import (
	...
	factoryBridge "github.com/TerraDharitri/drt-go-chain-sovereign-bridge/client"
	bridgeCfg "github.com/TerraDharitri/drt-go-chain-sovereign-bridge/client/config"
	notifierCfg "github.com/TerraDharitri/drt-go-chain-sovereign-notifier/config"
	"github.com/TerraDharitri/drt-go-chain-sovereign-notifier/factory"
	notifierProcess "github.com/TerraDharitri/drt-go-chain-sovereign-notifier/process"
	"github.com/google/gops/agent"

	"github.com/TerraDharitri/drt-go-chain/cmd/sovereignnode/notifier"
...
func (snr *sovereignNodeRunner) executeOneComponentCreationCycle(
	...
	nodeHandler, err := node.CreateNode(
		...
		configs.ImportDbConfig.IsImportDBMode,
		node.NewSovereignNodeFactory(configs.GeneralConfig.SovereignConfig.GenesisConfig.NativeDCDT),
...
func (snr *sovereignNodeRunner) CreateManagedStatusComponents(
	...
	statArgs := statusComp.StatusComponentsFactoryArgs{
		...
		CryptoComponents:     cryptoComponents,
		IsSovereign:          true,
		DCDTPrefix:           snr.configs.SystemSCConfig.DCDTSystemSCConfig.DCDTPrefix,
	}
