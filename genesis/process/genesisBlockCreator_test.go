...
import (
	...
	"github.com/TerraDharitri/drt-go-chain/common/runType"
...
func TestNewGenesisBlockCreator(t *testing.T) {
	...
	t.Run("nil RunTypeComponents should error", func(t *testing.T) {
		...
		gbc, err := NewGenesisBlockCreator(arg)
		require.ErrorIs(t, err, errorsDrt.ErrNilRunTypeComponents)
		require.Nil(t, gbc)
	})
	t.Run("nil BlockchainHookHandlerCreator should error", func(t *testing.T) {
		...
		gbc, err := NewGenesisBlockCreator(arg)
		require.ErrorIs(t, err, errorsDrt.ErrNilBlockChainHookHandlerCreator)
		require.Nil(t, gbc)
	})
	t.Run("nil SCResultsPreProcessorCreator should error", func(t *testing.T) {
		...
		gbc, err := NewGenesisBlockCreator(arg)
		require.ErrorIs(t, err, errorsDrt.ErrNilSCResultsPreProcessorCreator)
		require.Nil(t, gbc)
	})
	t.Run("nil SCProcessorCreator should error", func(t *testing.T) {
		...
		gbc, err := NewGenesisBlockCreator(arg)
		require.ErrorIs(t, err, errorsDrt.ErrNilSCProcessorCreator)
		require.Nil(t, gbc)
	})
	t.Run("nil TransactionCoordinatorCreator should error", func(t *testing.T) {
		...
		gbc, err := NewGenesisBlockCreator(arg)
		require.ErrorIs(t, err, errorsDrt.ErrNilTransactionCoordinatorCreator)
		require.Nil(t, gbc)
	})
	...
	t.Run("nil VMContextCreator, should error", func(t *testing.T) {
		...
		gbc, err := NewGenesisBlockCreator(arg)
		require.True(t, errors.Is(err, errorsDrt.ErrNilVMContextCreator))
		require.Nil(t, gbc)
	})
