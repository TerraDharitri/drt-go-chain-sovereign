...
type ValidatorDataV1 struct {
	...
	TotalStakeValue *math_big.Int `protobuf:"bytes,4,opt,name=TotalStakeValue,proto3,casttypewith=math/big.Int;github.com/TerraDharitri/drt-go-chain-core/data.BigIntCaster" json:"TotalStakeValue"`
	LockedStake     *math_big.Int `protobuf:"bytes,5,opt,name=LockedStake,proto3,casttypewith=math/big.Int;github.com/TerraDharitri/drt-go-chain-core/data.BigIntCaster" json:"LockedStake"`
	MaxStakePerNode *math_big.Int `protobuf:"bytes,6,opt,name=MaxStakePerNode,proto3,casttypewith=math/big.Int;github.com/TerraDharitri/drt-go-chain-core/data.BigIntCaster" json:"MaxStakePerNode"`
...
type UnstakedValue struct {
	...
	UnstakedValue *math_big.Int `protobuf:"bytes,2,opt,name=UnstakedValue,proto3,casttypewith=math/big.Int;github.com/TerraDharitri/drt-go-chain-core/data.BigIntCaster" json:"UnstakedValue"`
}
...
type ValidatorDataV2 struct {
	...
	TotalUnstaked   *math_big.Int    `protobuf:"bytes,10,opt,name=TotalUnstaked,proto3,casttypewith=math/big.Int;github.com/TerraDharitri/drt-go-chain-core/data.BigIntCaster" json:"TotalUnstaked"`
	TotalSlashed    *math_big.Int    `protobuf:"bytes,11,opt,name=TotalSlashed,proto3,casttypewith=math/big.Int;github.com/TerraDharitri/drt-go-chain-core/data.BigIntCaster" json:"TotalSlashed"`
}
...
type ValidatorConfig struct {
	MinStakeValue *math_big.Int `protobuf:"bytes,1,opt,name=MinStakeValue,proto3,casttypewith=math/big.Int;github.com/TerraDharitri/drt-go-chain-core/data.BigIntCaster" json:"MinStakeValue"`
	TotalSupply   *math_big.Int `protobuf:"bytes,2,opt,name=TotalSupply,proto3,casttypewith=math/big.Int;github.com/TerraDharitri/drt-go-chain-core/data.BigIntCaster" json:"TotalSupply"`
	MinStep       *math_big.Int `protobuf:"bytes,3,opt,name=MinStep,proto3,casttypewith=math/big.Int;github.com/TerraDharitri/drt-go-chain-core/data.BigIntCaster" json:"MinStep"`
	NodePrice     *math_big.Int `protobuf:"bytes,4,opt,name=NodePrice,proto3,casttypewith=math/big.Int;github.com/TerraDharitri/drt-go-chain-core/data.BigIntCaster" json:"NodePrice"`
	UnJailPrice   *math_big.Int `protobuf:"bytes,5,opt,name=UnJailPrice,proto3,casttypewith=math/big.Int;github.com/TerraDharitri/drt-go-chain-core/data.BigIntCaster" json:"UnJailPrice"`
}
