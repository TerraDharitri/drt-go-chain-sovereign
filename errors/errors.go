...
// ErrNilDCDTAsBalanceHandler signals that a nil dcdt as balance handler was provided
var ErrNilDCDTAsBalanceHandler = errors.New("nil dcdt as balance handler provided")
