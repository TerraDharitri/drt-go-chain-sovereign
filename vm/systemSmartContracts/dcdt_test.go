...
func TestNewDCDTSmartContract_InvalidTokenPrefixShouldErr(t *testing.T) {
	t.Parallel()

	args := createMockArgumentsForDCDT()
	args.DCDTSCConfig.DCDTPrefix = "Prefix"
...
func TestDcdt_CreateNewTokenIdentifierWithPrefix(t *testing.T) {
	t.Parallel()
	...
	dcdtSC, _ := NewDCDTSmartContract(args)
	output := dcdtSC.Execute(vmInput)
