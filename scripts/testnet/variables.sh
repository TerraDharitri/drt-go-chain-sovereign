...
export SOVEREIGNNODEDIR="$DHARITRIDIR/cmd/sovereignnode"
...
# For now, make sure that you checkout feat/sovereign branch from drt-chain-deploy repo when using these scripts
