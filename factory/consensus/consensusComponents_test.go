...
func TestNewConsensusComponentsFactory(t *testing.T) {
	...
	t.Run("nil extraSignersHolder, should error", func(t *testing.T) {
		...
		require.Nil(t, ccf)
		require.Equal(t, errorsDrt.ErrNilExtraSignersHolder, err)
	})
	t.Run("nil SubRoundEndV2Creator, should error", func(t *testing.T) {
		...
		require.Nil(t, ccf)
		require.Equal(t, errorsDrt.ErrNilSubRoundEndV2Creator, err)
	})
	...
	t.Run("nil BootstrapperFromStorageFactory should error", func(t *testing.T) {
		...
		require.Nil(t, ccf)
		require.Equal(t, errorsDrt.ErrNilBootstrapperFromStorageCreator, err)
	})
	t.Run("nil BootstrapperFactory should error", func(t *testing.T) {
		...
		require.Nil(t, ccf)
		require.Equal(t, errorsDrt.ErrNilBootstrapperCreator, err)
	})
	t.Run("nil ShardMessengerFactory should error", func(t *testing.T) {
		...
		require.Nil(t, ccf)
		require.Equal(t, errorsDrt.ErrNilBroadCastShardMessengerFactoryHandler, err)
	})
}
