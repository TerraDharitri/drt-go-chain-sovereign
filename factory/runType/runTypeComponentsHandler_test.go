...
import (
	...
	mockCoreComp "github.com/TerraDharitri/drt-go-chain/integrationTests/mock"
	"github.com/TerraDharitri/drt-go-chain/testscommon"
	"github.com/TerraDharitri/drt-go-chain/testscommon/enableEpochsHandlerMock"
	factoryMock "github.com/TerraDharitri/drt-go-chain/testscommon/factory"
...
func TestManagedRunTypeComponents_CheckSubcomponents(t *testing.T) {
	...
	//TODO check for nil each subcomponent - DRT-15371
	err = managedRunTypeComponents.CheckSubcomponents()
	require.NoError(t, err)
...
func createArgsRunTypeComponents() runType.ArgsRunTypeComponents {
	acc1 := data.InitialAccount{
		Address:      "drt1whq0zspt6ktnv37gqj303da0vygyqwf5q52m7erftd0rl7laygfs8lqzm4",
		Supply:       big.NewInt(2),
