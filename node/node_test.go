...
func TestNode_GetAllDCDTTokensForNFTWithPrefix(t *testing.T) {
	t.Parallel()
...
func testNodeGetAllIssuedDCDTs(t *testing.T, nodeFactory node.NodeFactory, shardId uint32) {
	acc := createAcc([]byte("newaddress"))
...
func TestNode_GetAllDCDTTokens_ShouldWork(t *testing.T) {
	t.Parallel()

	testNodeGetAllIssuedDCDTs(t, node.NewNodeFactory(), core.MetachainShardId)
}

func TestNode_GetAllDCDTTokens_WrongChainId(t *testing.T) {
	t.Parallel()
...
func testNodeGetDCDTsWithRole(t *testing.T, nodeFactory node.NodeFactory, shardId uint32) {
	...
	t.Run("get DCDTs with role NFT add quantity should work", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("get DCDTs with role local mint should work", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("get DCDTs with role NFT create should work", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("invalid role should error", func(t *testing.T) {
		...
		tokenResult, _, err := n.GetDCDTsWithRole(testscommon.TestAddressAlice, "invalid role", api.AccountQueryOptions{}, context.Background())
		require.Equal(t, node.ErrInvalidDCDTRole, err)
		require.Nil(t, tokenResult)
	})
	t.Run("invalid address should error", func(t *testing.T) {
		t.Parallel()

		tokenResult, _, err := n.GetDCDTsWithRole("aaaaa", core.DCDTRoleNFTCreate, api.AccountQueryOptions{}, context.Background())
...
func TestNode_GetDCDTsWithRole(t *testing.T) {
	...
	testNodeGetDCDTsWithRole(t, node.NewNodeFactory(), core.MetachainShardId)
}

func TestNode_GetDCDTsWithRole_WrongChainId(t *testing.T) {
	t.Parallel()
	...
	res, _, err := n.GetDCDTsWithRole(testscommon.TestAddressAlice, core.DCDTRoleNFTCreate, api.AccountQueryOptions{}, context.Background())
	require.Nil(t, res)
	require.Equal(t, node.ErrMetachainOnlyEndpoint, err)
}

func testNodeGetDCDTsRoles(t *testing.T, nodeFactory node.NodeFactory, shardId uint32) {
	addrBytes := testscommon.TestPubKeyAlice
	acc := createAcc(addrBytes)
	dcdtToken := []byte("TCK-RANDOM")
	...
	t.Run("get DCDTs roles should work", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("invalid address should fail", func(t *testing.T) {
		...
		tokenResult, _, err := n.GetDCDTsRoles("aaaaa", api.AccountQueryOptions{}, context.Background())
		require.Equal(t, "invalid bech32 string length 5", err.Error())
		require.Nil(t, tokenResult)
	})
}
...
func TestNode_GetDCDTsRoles_WrongChainId(t *testing.T) {
	t.Parallel()
...
func getDefaultProcessComponents() *factoryMock.ProcessComponentsMock {
	return &factoryMock.ProcessComponentsMock{
		...
		DCDTDataStorageHandlerForAPIInternal: &testscommon.DcdtStorageHandlerStub{},
