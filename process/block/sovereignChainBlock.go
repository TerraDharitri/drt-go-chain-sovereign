...
import (
	...
	sovCore "github.com/TerraDharitri/drt-go-chain-core/data/sovereign"
...
func (scbp *sovereignChainBlockProcessor) RestoreBlockIntoPools(header data.HeaderHandler, body data.BodyHandler) error {
	...
	// TODO: DRT-16507: check how/if to restore incoming scrs/cross chain txs once we have a testnet setup for it
...
// TODO: (sovereign) remove these cleanUpFunc pointer functions once shardCoordinator will return the correct shard id from task: DRT-14132
