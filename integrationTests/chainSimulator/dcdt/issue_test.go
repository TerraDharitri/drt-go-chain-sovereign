...
func TestChainSimulator_IssueDCDTWithPrefix(t *testing.T) {
	if testing.Short() {
	...
	cs, err := chainSimulator.NewChainSimulator(chainSimulator.ArgsChainSimulator{
		...
		AlterConfigsFunction: func(cfg *config.Configs) {
			cfg.SystemSCConfig.DCDTSystemSCConfig.DCDTPrefix = tokenPrefix
	...
	require.Nil(t, err)
	chainSim.TransferDCDT(t, cs, initialAddrBytes, receiverBytes, &nonce, issuedToken, receivedTokens)
