...
The **Dharitri Sovereign Node** exposes the following Command Line Interface:

```
$ sovereignNode --help

NAME:
   Dharitri Sovereign Node CLI App - This is the entry point for starting a new Dharitri sovereign node - the app will start after the genesis timestamp
USAGE:
