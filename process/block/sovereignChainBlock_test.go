...
import (
	...
	storageStub "github.com/TerraDharitri/drt-go-chain/testscommon/storage"
	storageStubs "github.com/TerraDharitri/drt-go-chain/testscommon/storage"

	"github.com/TerraDharitri/drt-go-chain-core/core"
	"github.com/TerraDharitri/drt-go-chain-core/data"
	"github.com/TerraDharitri/drt-go-chain-core/data/block"
	sovereignCore "github.com/TerraDharitri/drt-go-chain-core/data/sovereign"
...
func TestSovereignBlockProcessor_NewSovereignChainBlockProcessorShouldWork(t *testing.T) {
	...
	t.Run("should error when outgoing operations formatter is nil", func(t *testing.T) {
		...
		require.Nil(t, scbp)
		require.ErrorIs(t, err, errDrt.ErrNilOutgoingOperationsFormatter)
	})
	...
	t.Run("should error when outgoing operation pool is nil", func(t *testing.T) {
		...
		require.Nil(t, scbp)
		require.Equal(t, errDrt.ErrNilOutGoingOperationsPool, err)
	})
	...
	t.Run("should error when operations hasher is nil", func(t *testing.T) {
		...
		require.Nil(t, scbp)
		require.Equal(t, errDrt.ErrNilOperationsHasher, err)
	})
...
func TestSovereignChainBlockProcessor_RestoreBlockIntoPoolsInvalidHeaderType(t *testing.T) {
	...
	require.ErrorIs(t, err, errDrt.ErrWrongTypeAssertion)
}
...
//TODO: More unit tests should be added. Created PR https://dharitrilabs.atlassian.net/browse/DRT-14149
