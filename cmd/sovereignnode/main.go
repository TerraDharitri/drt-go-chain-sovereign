...
func main() {
	...
	app.Name = "Dharitri Sovereign Node CLI App"
	...
	app.Usage = "This is the entry point for starting a new Dharitri sovereign node - the app will start after the genesis timestamp"
	app.Flags = getFlags()
