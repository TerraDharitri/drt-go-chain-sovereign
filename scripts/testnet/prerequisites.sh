...
git clone git@github.com:dharitri/drt-go-chain-deploy-sovereign.git
git clone git@github.com:dharitri/drt-go-chain-proxy-sovereign.git

if [ "$SOVEREIGN_DEPLOY" -eq 1 ]; then
    pushd .
    git clone git@github.com:dharitri/drt-go-chain-sovereign-bridge.git
    ...
    pushd .
    git clone --no-checkout https://github.com/TerraDharitri/drt-go-chain-tools.git
